...
### HuggingFace Space 
- Stock Predict Prophet 世界股價預測 (使用Prophet方法)(布林通道Bollinger Bands，BBands)
  https://huggingface.co/spaces/tbdavid2019/Stock-Predict-Prophet
- TwStock Predict  LSTM 台灣股市的股價預測(使用LSTM方法)
  https://huggingface.co/spaces/tbdavid2019/twStock-predict
- 世界 潛力股列表 (使用LSTM方法)
  https://huggingface.co/spaces/tbdavid2019/twStock-Underdogs
- K線 辨識  61種
  http://git-gl.david888.com:5678/
- 語音轉文字 STT (Whisper)
  https://huggingface.co/spaces/tbdavid2019/whisper-stt
- 製作Podcast 的工具 (Whisper)
  https://huggingface.co/spaces/tbdavid2019/PDF2podcast
...
- [Oli 家: 面相 算命](https://chatgpt.com/g/g-67445071ff3081918c3076ad860be46a-oli-jia-mian-xiang-suan-ming)
...
#### HuggingFace Space
潛力股 完整版
- https://huggingface.co/spaces/tbdavid2019/Stock-Underdogs
LLM2 - liberchat
- https://huggingface.co/spaces/tbdavid2019/liberchat
#### Vercel
LLM3 - nextChat 
- https://llmchat-rouge.vercel.app

#### Colab 
- whisper轉錄逐字稿加上gemini會議總結
  https://colab.research.google.com/drive/1nO918SBJZngMcaIzGjykOKqDTQ_T21yD
- 新聞爬蟲
  https://colab.research.google.com/drive/1HwFJLTXo0UWRhMrP3N2M4XgBILfzrCaA
 - 股市預測
   https://colab.research.google.com/drive/1V30GA2wpWe2Twj7XWUZ2VLZQRYNnXZdQ
